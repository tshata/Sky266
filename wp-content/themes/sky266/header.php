                        ...
                        <div id="logo_div" class="col-sm-2 col-xs-12">
                            <div class="logo">
                                <h1><a href="<?php echo esc_url( home_url( '/' ) ); ?>"><img
                                            src="<?php echo get_template_directory_uri() . '/img/logo.jpg';?>" alt=" "
                                ...
                                <div class="collapse navbar-collapse navbar-collapse">
                                    ...
                                    <ul class="nav navbar-nav hidden-sm">
                                        <li class="<?php echo ($pagename=="")? "active" : ""; ?>"><a
                                                href="<?php echo esc_url( home_url( '/' ) ); ?>">Home</a><span>|</span>
                                        </li>
                                        <li class="<?php echo ($pagename=="About Us")? "active" : ""; ?>"><a
                                                href="<?php echo esc_url( home_url( 'index.php/about-us' ) ); ?>">About
                                                Us</a><span>|</span></li>
                                        <!-- Services -->
                                        <li class="dropdown <?php echo ($pagename=="Our Services")? "active" : ""; ?>">
                                            <a href="<?php echo esc_url( home_url( 'index.php/our-services' ) ); ?>">Services
                                                <b class="caret"></b></a><span>|</span>
                                            <!-- submenu-wrapper -->
                                                    ...
                                                    <ul class="dropdown-menu">
                                                        <?php
                                                                 ...
                                                                 ?> <?php $post_id= $service_menu->ID ;
                                                                  ...
                                                                  ?>
                                                        <li
                                                            class="<?php echo ($pagename==$post_title)? "active" : ""; ?>">
                                                            <a
                                                                href="<?php echo esc_url($link); ?>"><?php echo $post_title; ?></a>
                                                        </li>
                                                        <?php endforeach;
                                                              wp_reset_query(); ?>
                                                    </ul>
                                        ...
                                        <li class="<?php echo ($pagename=="Gallery")? "active" : ""; ?>"><a
                                                href="<?php echo esc_url( home_url( 'index.php/our-gallery' ) ); ?>">Gallery</a><span>|</span>
                                        </li>
                                        <li class="<?php echo ($pagename=="Contact")? "active" : ""; ?>"><a
                                                href="<?php echo esc_url( home_url( 'index.php/contact' ) ); ?>">Contact</a>
                                        </li>
                            ...
                            <div class="right-links">
                                <ul class="list-inline">
                                    ...
                                    <li><a class="btn btn-primary"
                                            href="<?php echo esc_url( home_url( 'index.php/register' ) ); ?>">Register<i
                                                class="fa"></i></a>
                                        <?php } ?>
                                        <?php if( !is_user_logged_in()){ ?>
                                    <li><a class="btn btn-primary"
                                    ...
                                    <li><a class="btn btn-primary"
                                            href="<?php echo esc_url( home_url( 'index.php/request-quote' ) ); ?>">Quote/Book</a>
                                    </li>
                                        ...
                                        <div class="submenu-wrapper submenu-wrapper-topbottom">
                                            <div class="submenu-inner  submenu-inner-topbottom">
                                                <ul class="dropdown-menu" style="background: white;">
                                                    <li><a
                                                            href="<?php echo esc_url( home_url( 'index.php/my-account' ) ); ?>">Dashboard<i
                ...
                <div id="main-carousel" class="carousel slide hero-slide" data-ride="carousel">
                    ...
                    <div class="carousel-inner" role="listbox">
                        <div class="item active">
                            <img src="<?php echo get_template_directory_uri(). '/img/slider/slide-11.jpg';?>"
                                alt="Hero Slide">
                            <!--Slide Image-->
                        </div>
                        <!--.item-->
                        ...
                        <div class="item">
                            <img src="<?php echo get_template_directory_uri(). '/img/slider/slide-12.jpg';?>"
                                alt="Hero Slide">
                            <!--Slide Image-->
                        </div>
                        <!--.item-->
                        <div class="item">
                            <img src="<?php echo get_template_directory_uri(). '/img/slider/slide-13.jpg';?>"
                                alt="Hero Slide">
                            <!--Slide Image-->
                        </div>
                        <!--.item-->
                        ...
                        <div class="item">
                            <img src="<?php echo get_template_directory_uri(). '/img/slider/slide-14.jpg';?>"
                                alt="Hero Slide">
                            <!--Slide Image-->
                        </div>
                        <!--.item-->
                        ...
                        <div class="container">
                            <div class="carousel-caption">
                                <div class="wpcargo-track wpcargo">
                                    <form method="post" name="wpcargo-track-form"
                                        action="<?php echo esc_url( home_url( 'index.php/track-form' ) ); ?>">
                                        ...
                                        <table id="wpcargo-track-table" class="track_form_table">
                                            <tr class="track_form_tr">
                                                <th class="track_form_th" colspan="2">
                                                    <h4><?php echo apply_filters('wpcargo_tn_form_title', esc_html__('TRACK YOUR PARCEL', 'wpcargo') ); ?>
                                                    </h4>
                                                </th>
                                            </tr>
                                            <tr class="track_form_tr">
                                                <?php do_action('wpcargo_add_form_fields'); ?>
                                                <td class="track_form_td"><input class="input_track_num" type="text"
                                                        name="wpcargo_tracking_number" value="" autocomplete="off"
                                                        placeholder="<?php echo apply_filters('wpcargo_tn_placeholder', esc_html__('Enter the Tracking No. (e.g: 12345)', 'wpcargo' ) ); ?>"
                                                        required></td>
                                                <td class="track_form_td submit-track"><input id="submit_wpcargo"
                                                        class="wpcargo-btn wpcargo-btn-primary" name="wpcargo-submit"
                                                        type="submit"
                                                        value="<?php echo apply_filters('wpcargo_tn_submit_val', esc_html__( 'TRACK RESULT', 'wpcargo' ) ); ?>">
                                                </td>
                                            </tr>
                                        </table>
                                    </form>
