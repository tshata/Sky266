            ...
            <div id="welcom" class="col-md-4 col-sm-12">
                <div class="service-left-box">
                    ...
                    <div class="service-intro">
                        <p>This is Margueritte McAllister, headmistress of the Spencer School for Girls in Wildwood, New
                            Jersey. Is Mr. or Mrs. Lando home? Yes, this is she. Mrs. Lando, as you know, we pride
                            ourselves on turning troubled girls into healthy, productive young women. But if they are
                            not here, there is very little we can do. Now, Mathilda left school without permission
                            nearly two weeks ago.</p>
                    </div>
                    <!--/.service-intro-->
                    ...
                    <div class="carousel-inner" role="listbox">
                        ...
                        <div class="col-sm-6 col-xs-12">
                            <div class="service-content">
                                ...
                                <a class="btn btn-primary" href="about-us">Read More<i
        ...
        <div class="row">
            <div class="col-xs-12">
                <div class="feature-content">
                    ...
                    <div>
                        <p>Etiam non augue in tortor facilisis porttitor at sit amet justo. Sed blandit tempor
                            hendrerit. Suspendisse quis tincidunt nisl. Nulla bibendum purus elit, ut hendrerit orci
                            porttitor id. Donec egestas dapibus massa, et tempor nulla ultricies quis. Donec mattis,
                            metus vel pharetra pulvinar, nunc leo consectetur purus, sit amet tincidunt dui lorem ac
                            elit. Vivamus nulla nisl, sodales eu rutrum sit amet, viverra eu eros. Proin sollicitudin
                            congue augue, eget condimentum purus dictum sit amet. Aenean et tempor augue.</p>
                    </div>
                    <a href="<?php echo esc_url( home_url( 'index.php/request-quote' ) ); ?>"
                        class="btn btn-primary quote-btn btn-lg">Get a Quote <i class="fa fa-long-arrow-right"></i></a>
                ...
                <div class="about-us-content">
                    ...
                    <div class="about-content-block">
                        ...
                        <p>Progressively architect prospective imperatives through competitive communities.
                            Professionally productize user strategic theme areas.</p>
                    </div>
                    <br>
                    <div class="about-content-block">
            ...
            <div class="col-sm-4 col-xs-12">
                <div class="about-us-content">
                    ...
                    <div class="about-content-block">
                        <span>Distinctively Orchestrate Standardized</span>
                        <p>Progressively architect prospective imperatives through competitive communities.
                            Professionally productize user strategic theme areas.Professionally productize user
                    ...
                    <div class="owl-carousel fleet-carousel">
                        ...
                        <div class="item">
                            <div class="owl-item-thumb">
                                ...
                                <a class="img-link" href="<?php echo $wpblog_fetrdimg;?>"><img
                                        src="<?php echo get_template_directory_uri() . '/img/zoomin.png';?>"
                                        alt="+" /></a>
                            </div><!-- owl-item-thumb -->
                            <div class="owl-tem-content">
                                <h3><a href="#"><?php echo $post_title; ?></a></h3>
                                <p><a class="btn btn-primary" href="<?php echo $link; ?>">Read More<i
