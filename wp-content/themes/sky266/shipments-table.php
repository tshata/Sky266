    ...
    <table id="dataTable" class="display table wpcargo-table-responsive-md wpcargo-table" style="width:100%;">
        ...
        <tbody>
            ...
            <tr>
                ...
                <td><?php echo wpcargo_get_postmeta( get_the_ID(), 'wpcargo_origin_field' )." ".wpcargo_get_postmeta( get_the_ID(), 'wpcargo_origin_city_field' ); ?>
                </td>
                <td><?php echo wpcargo_get_postmeta( get_the_ID(), 'wpcargo_destination' )." ".wpcargo_get_postmeta( get_the_ID(), 'wpcargo_destination_city' ); ?>
                </td>
                <td><?php echo wpcargo_get_postmeta( get_the_ID(), 'wpcargo_receiver_fname' )." ".wpcargo_get_postmeta( get_the_ID(), 'wpcargo_receiver_sname' ); ?>
                </td>
                ...
                <td><a href="#wpcargo-account" data-id="<?php echo get_the_ID(); ?>"
                        id="shipments_single"><?php esc_html_e( 'View Details', 'textdomain' ); ?></a></td>
            </tr>
            <?php
						endwhile;
						else :
						?>
            <tr>
                <td colspan="<?php echo !in_array( 'administrator', $user_info->roles ) ? 6 : 5 ; ?>">
                    <?php esc_html_e('No shipment found!', 'wpcargo' ); ?></td>
            </tr>
            <?php
					endif;
				?>
