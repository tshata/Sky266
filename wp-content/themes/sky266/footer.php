			        ...
			        <footer class="copyright-section">
			        	<div class="container">
			        		...
			        		<div class="copyright-info">
			        			<span>Copyright&reg;2020 <a href="https://www.sky266.co.ls">Sky266</a>. All Rights Reserved. Designed by <a href="https://www.tech-corp.co.ls">Tech-Corp</a></span>
			        		</div>
			        	</div><!-- /.container -->
			        </footer>
	    	...
	    	<div class="offcanvas-menu offcanvas-effect">
	    		<div class="offcanvas-wrap">
                    ...
                    <?php  $pagename = $wp_query->post->post_title; ?>
			            <li class="<?php echo ($pagename=="")? "active" : ""; ?>"><a href="<?php echo esc_url( home_url( '/' ) ); ?>">Home</a></li>
			            <li class="<?php echo ($pagename=="About Us")? "active" : ""; ?>"><a href="<?php echo esc_url( home_url( 'index.php/about-us' ) ); ?>">About Us</a></li>
			            <li class="dropdown <?php echo ($pagename=="Our Services")? "active" : ""; ?>"><a href="#">Services <b class="caret"></b></a><span>|</span>
                            <!-- submenu-wrapper -->
                        ...
                        <li class="<?php echo ($pagename=="Request Quote")? "active" : ""; ?>"><a href="<?php echo esc_url( home_url( 'index.php/request-quote' ) ); ?>">Request Quote</a></li>
			  			<li class="<?php echo ($pagename=="Book Now")? "active" : ""; ?>"><a href="<?php echo esc_url( home_url( 'index.php/request-quote' ) ); ?>">Book Now</a></li>
			  			<?php if( !is_user_logged_in()){ ?> <li><a href="<?php echo esc_url( home_url( 'index.php/my-account' ) ); ?>">Login<i class="fa fa-key"></i></a></li> <?php } ?>
