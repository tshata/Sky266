<div class="wpc-mp-wrap">
    <h2><?php echo apply_filters('wpc_shipment_details_label', esc_html__('Parcel Details', 'wpcargo' ) ); ?></h2>
    ...
    <table id="wpcargo-package-table" class="wpc-multiple-package wpc-repeater">
        ...
        <tbody data-repeater-list="<?php echo WPCARGO_PACKAGE_POSTMETA; ?>">
            ...
            <tr data-repeater-item class="wpc-mp-tr">
                ...
                <?php endforeach; ?>
                <td><input data-repeater-delete type="button" class="wpc-delete"
                        value="<?php esc_html_e('Delete','wpcargo'); ?>" /></td>
            ...
            <tr data-repeater-item class="wpc-mp-tr">
                ...
                <td style="line-height: 16px;">
                    <center>
                        <input type="checkbox" onclick="toggle_dimentions(this)"
                            style="width: 14px; height: 14px;" />Unknown
                    </center>
                </td>
                <td style="line-height: 16px;">
                    <center>
                        <a style="color: red; cursor: pointer;" data-repeater-delete>
                            <?php esc_html_e('Delete Row','wpcargo'); ?></a>
                    </center>
                </td>
            </tr>
            <?php endif; ?>
        ...
        <tfoot>
            ...
            <tr class="wpc-computation">
                <td colspan="3" style="border: none;"><input data-repeater-create type="button" class="wpc-add"
                        value="<?php esc_html_e('Add Parcel','wpcargo'); ?>" /></td>
            </tr>
        </tfoot>
    </table>
