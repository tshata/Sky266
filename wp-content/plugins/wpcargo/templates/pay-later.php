<div id="wpcargo-result-wrapper">
    <div class="wpcargo-result wpcargo" id="wpcargo-result" style="border: solid 1px white; padding-bottom: 40px;">
        <?php
		$shipment_id = wpcargo_trackform_shipment_number("SKY-020892-CARGO");
