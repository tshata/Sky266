...
<div id="myModal" class="modal">
    ...
    <div >
            ...
            <div class="modal-content" id="payment_details" style="font-size:1em;">
                <p class="wpcargo-label" style="margin-bottom: 1px; font-size: 1.5em;color:white;"><strong id="heading"><?php // apply_filters( 'wpc_multiple_package_header', esc_html_e( 'Mpesa/Ecocash Payment Details', 'wpcargo' ) ); ?></strong></p>
                ...
                <br>
                 ...
                 <button style="float:right;margin: 0 .4em 0 .4em;" type="button" id="modal_close" >Close</button><br><br> </div>
            </div>
    </div>
