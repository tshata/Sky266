...
<form id="regForm" class="shipping-form" method="post">
    <div>
        ...
        <div class="tab" id="titlewrap">
            <input name="post_name" hidden="hidden" id="title"
                value="<?php echo $wpcargo->create_shipment_number(); ?>">
        ...
        <div class="tab" id="collection_tab">
            <h2><?php echo apply_filters('wpc_shipment_details_label', esc_html__('Collection Details', 'wpcargo' ) ); ?>
            </h2>
            ...
            <div style="margin-bottom: 20px; margin-left: 50px; display: none;" id="col_time">
                ...
                <div style="margin-left: 50px;">
                    <div><input type='checkbox' onclick="collection_hours(this)" disabled="disabled" checked="checked"
                            name="working_hours" style="width: 15px; height: 15px;" id="working_hours"><label
                            style="font: bolder;">&nbsp;Working Hours: <b>08:00 - 16:30hrs</b></label><br
                            style="line-height: 0px;"> </div>
                    <div><input type='checkbox' onclick="collection_hours(this)" name="after_hours"
                            style="width: 15px; height: 15px;" id="after_hours"><label style="font: bolder;"
                            id="after_hours_label">&nbsp;After Hours</label> </div>
            ...
            <div class="wpcargo-row">
                <label class="wpcargo-col-md-6">
                    <center><input id="trip_1" name="trip_1" style="width: 15px; height: 15px;" type="checkbox"
                            onclick="trip_select(this)" data-group='trip_select'>&nbsp;Select Trip1</center>
                </label>
                <label class="wpcargo-col-md-6">
                    <center><input id="trip_2" name="trip_2" style="width: 15px; height: 15px;" type="checkbox"
                            onclick="trip_select(this)" data-group='trip_select'>&nbsp;Select Trip2</center>
                </label>
            </div><br><br>
        ...
        <div class="tab" id="receiver-details">
            <h2><?php echo apply_filters('wpc_receiver_details_label',esc_html__('Your Details', 'wpcargo' ) ); ?></h2>
            <hr style="border: 1px solid black;" /><br>
            ...
            <div class="wpcargo form-table wpcargo-row">
                ...
                <div class="wpcargo-col-md-6"><br>
                    <div><label class="form-label"> <?php esc_html_e('Your Main Phone Number', 'wpcargo'); ?> </label>
                    </div>
                    ...
                    <input class="wpcargo-col-md-5" style="width: 20px; height: 20px; margin: 3px 3px 3px 3px;"
                        type='checkbox' name="whatsapp_1" id="whatsapp_1"><label style="font: bolder;">has<img
                            style="width: 30px;" src="<?php echo WPCARGO_PLUGIN_URL."assets/images/whatsapp.png"; ?>"
                            title="Has whatsapp" alt="Whatsapp"></label>
                </div>
                <div class="wpcargo-col-md-6"><br>
                    <div><label class="form-label"> <?php esc_html_e('Your Alternative Phone Number', 'wpcargo'); ?>
                        </label></div>
                    ...
                    <input class="wpcargo-col-md-5" style="width: 20px; height: 20px; margin: 3px 3px 3px 3px;"
                        type='checkbox' name="whatsapp_2" id="whatsapp_2"><label style="font: bolder;">has<img
                            style="width: 30px;" src="<?php echo WPCARGO_PLUGIN_URL."assets/images/whatsapp.png"; ?>"
                            title="Has whatsapp" alt="Whatsapp"></label>
                </div>
                <div class="wpcargo-col-md-12"><br>
                    <div><label class="form-label"> <?php esc_html_e('Email', 'wpcargo'); ?> </label></div>
                    <div><input type="email" style="width: 100%;" class="notvalidate" id="wpcargo_receiver_email"
   ...
   ?>
        ...
        <div class="tab" id="collection-instructions">
            <h2><?php echo apply_filters('wpc_receiver_details_label',esc_html__('Collection Instructions', 'wpcargo' ) ); ?>
            </h2>
            <hr style="border: 1px solid black;" /><br>
            <div>
                <label class="form-label"> <?php esc_html_e('Collection Reference', 'wpcargo'); ?> </label> <br
                    style="line-height: 2px;">
                <input style="margin-left: 50px; width: 50%;" type="text" class="notvalidate"
                    placeholder="Collection Reference" id="collection_reference" name="collection_reference"
            ...
            <div> <br>
                ...
                <textarea rows="4" name="collection_instructions" id="collection_instructions"
                    style="overflow: hidden; word-wrap: break-word; resize:none;  height: 180px; margin-left: 50px; width: 50%; "
            ...
            <div> <br> <label class="form-label" for="label">Agree boxes: </label> <br style="line-height: 2px;">
                <div style="margin-left: 50px;" id="agree_boxes">
                    <label><input style="width: 15px; height: 15px;" type='checkbox' onclick="checkAgreeboxes()"><label
                            style="font: bolder;">&nbsp;Agree Box</label></label><br>
                    <label><input style="width: 15px; height: 15px;" type='checkbox' onclick="checkAgreeboxes()"> <label
                            style="font: bolder;">&nbsp;Agree Box</label></label><br>
                    <label><input style="width: 15px; height: 15px;" type='checkbox' onclick="checkAgreeboxes()"> <label
                            style="font: bolder;">&nbsp;Agree Box</label></label><br>
                    <label><input style="width: 15px; height: 15px;" type='checkbox' onclick="checkAgreeboxes()"> <label
                            style="font: bolder;">&nbsp;Agree Box</label></label>
                </div>
            </div> <br><br>
        </div>
