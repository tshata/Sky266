...
@media only screen and (max-width:767px) {
    ...
    #list-container .wpc-ca-list-tr {
        display: block;
    }

    #list-container .wpc-ca-list-thead .wpc-ca-list-tr {
        position: absolute;
        top: -9999px;
        left: -9999px;
    }
    ...
    #list-container .wpc-ca-list-td:before {
        position: absolute;
        top: 6px;
        left: 6px;
        width: 45%;
    ...
    .wpc-ca-list-td:nth-of-type(1):before {
        content: "Tracking #";
    }

    <?php if( !empty($cf_fields)) {
        $counter_thead=2;

        foreach($cf_fields as $result) {
            ?>.wpc-ca-list-td: nth-of-type(<?php echo $counter_thead; ?>):before {
                content: "<?php echo $result->label; ?>";
            }
    ...
    ?>.wpc-ca-list-td:nth-of-type(5):before {
        content: "<?php echo esc_html__('View More', 'wpcargo'); ?>"
    }
}
</style>
            ...
            <tbody>
                ...
                <tr>
                    ...
                    <?php
								...
								?>
                    <td><a class="view-shipment" href="#"
                            data-id="<?php echo get_the_ID(); ?>"><?php esc_html_e('View Details', 'wpcargo'); ?></a>
                    </td>
                </tr>
                <?php
						endwhile;
						...
						?><tr>
                    <td colspan="<?php echo count( $cf_fields ) + 2; ?>">
