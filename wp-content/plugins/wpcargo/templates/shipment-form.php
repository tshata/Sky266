...
#shipment-details .form-table, #shipment-details .form-table td, #shipment-details .form-table tr, #shipment-details .form-table th{
    border:none;
}
...
<div id="shipment-details">
  <input type="hidden" id="route_abrs" name="route_abrs" value="">
    <h2><?php echo apply_filters('wpc_shipment_details_label', esc_html__('Shipment Details', 'wpcargo' ) ); ?></h2><hr style="border: 1px solid black;"/><br>
        ...
        <div class="wpcargo-col-md-6">
			...
			<td>
				<?php $countries = wpc_get_countries_cities("GROUP BY country_name");
                    if( !empty($countries) ){ ?>
					<select id="org_1" name="wpcargo_origin_field" id="wpcargo_origin_field" onchange="schedule_selector(this)">
        ...
        <div class="wpcargo-col-md-6">
			...
			<td><br>
					<select id="org_1_1" name="wpcargo_origin_city_field" onchange="schedule_selector(this)">
						<option data-value="" data-city_id="" data-moreinfo="" selected value=""><?php esc_html_e('-- Select One --', 'wpcargo' ); ?></option>
      ...
      <div class="wpcargo-col-md-6" id="col_time">  <br>
            <i style="font-size: 11px; display: block;"><b>Note that collection fee will be charged for this service</b></i>
             ...
             <td><div style="margin-left: 50px;">
                <div><input type='checkbox' onclick="collection_hours(this)" disabled="disabled" checked="checked" name="col_working_hours" style="width: 15px; height: 15px;"  id="col_working_hours" ><label style="font: bolder;">&nbsp;Working Hours: <b>08:00 - 16:30hrs</b></label><br style="line-height: 0px;"> </div>
                <div><input type='checkbox' onclick="collection_hours(this)" name="col_after_hours" style="width: 15px; height: 15px;" id="col_after_hours"><label style="font: bolder;" id="col_after_hours_label">&nbsp;After Hours</label> </div>
                 <p class="wpcargo-col-md-5" 0 id="time_note"></p>
             </div></td>
      </div>
      <div class="wpcargo-col-md-6" id="del_time">  <br>
            <i style="font-size: 11px; display: block;"><b>Note that delivery fee will be charged for this service</b></i>
             <th><label class="form-label" for="label">Delivery Times: </label></th>
             <td><div style="margin-left: 50px;">
                <div><input type='checkbox' onclick="collection_hours(this)" disabled="disabled" checked="checked" name="del_working_hours" style="width: 15px; height: 15px;"  id="del_working_hours" ><label style="font: bolder;">&nbsp;Working Hours: <b>08:00 - 16:30hrs</b></label><br style="line-height: 0px;"> </div>
                <div><input type='checkbox' onclick="collection_hours(this)" name="del_after_hours" style="width: 15px; height: 15px;" id="del_after_hours"><label style="font: bolder;" id="del_after_hours_label">&nbsp;After Hours</label> </div>
                 <p class="wpcargo-col-md-5" 0 id="time_note"></p>
             </div></td>
      </div>
