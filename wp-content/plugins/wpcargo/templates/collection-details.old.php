      ...
      <h2><?php echo apply_filters('wpc_shipper_details_label',esc_html__('Collection Details', 'wpcargo' ) ); ?></h2>
        ...
        <table class="wpcargo form-table">
            ...
            <tr>
                ...
                <td>
                      <select style="margin-left: 2%; width: 95%;" id="address_type" name="address_type" onchange="address_fields_toggle(this)">
          ...
          <!-- residential address fields -->
            ...
            <tr class="business residential">
                ...
                <td><input type="text" class="notvalidate" id="wpcargo_shipper_phone" name="wpcargo_shipper_phone" value="<?php echo get_post_meta($post->ID, 'wpcargo_shipper_phone', true); ?>" size="25" /></td>
            </tr>
            ...
            <tr class="residential">
                ...
                <td><input type="text" class="notvalidate" id="wpcargo_shipper_address" name="wpcargo_shipper_address" value="<?php echo get_post_meta($post->ID, 'wpcargo_shipper_address', true); ?>" size="25" /></td>
            </tr>
            <tr class="business">
            ...
            <tr class="business residential">
                ...
                <td><input type="email" class="notvalidate" class="notvalidate" id="wpcargo_shipper_email" name="wpcargo_shipper_email" value="<?php echo get_post_meta($post->ID, 'wpcargo_shipper_email', true); ?>" size="25" /></td>
            </tr>
