...
<div class="tab" id="package_tab">
    <h2>Package details</h2><hr style="border: 1px solid #000;"/><br>
      <div >
            <label class="form-label" for="label">Goods Description and Quantities: </label> <br style="line-height: 2px;">
            <textarea rows="4" name="goods_description" id="goods_description" style="overflow: hidden; word-wrap: break-word; resize:none; width:50%;margin-left:.7em;color:white;" placeholder="--type description and quantities of goods/items here--"></textarea>
      </div>
...
<div class="tab" id="collection_tab">
    <h2><?php echo apply_filters('wpc_shipment_details_label', esc_html__('Special services', 'wpcargo' ) ); ?></h2><hr style="border: 1px solid black;"/><br>
     <div>
...
<div class="tab" id="price-estimates">
      ...
      <div class="wpcargo-row">
          <label class="wpcargo-col-md-6"><center><input id="trip_1" name="trip_1" style="width: 15px; height: 15px;" type="checkbox" onclick="trip_select(this)" data-group='trip_select'>&nbsp;Select Collection date 1</center></label>
          <label class="wpcargo-col-md-6"><center><input id="trip_2" name="trip_2" style="width: 15px; height: 15px;" type="checkbox" onclick="trip_select(this)" data-group='trip_select'>&nbsp;Select Collection date 2</center></label>
      </div><br><br>
...
<div class="tab" id="receiver-details">
     <h2><?php echo apply_filters('wpc_receiver_details_label',esc_html__('Shippers Details', 'wpcargo' ) ); ?><span style="font-size: .6em;font-style: italic;margin-left:.7em;"> (Details of the Company or Person making a booking)</span></h2><hr style="border: 1px solid black;"/><br>
        ...
        <?php do_action('wpc_before_receiver_details_metabox', $post->ID); ?>
         <div class="wpcargo form-table wpcargo-row" >
            <div class="wpcargo-col-md-6" style="margin-bottom: 1.5em;">
              <div><label class="form-label"> <?php esc_html_e('Company Name', 'wpcargo'); ?> <span style="font-size: .87em;font-style: italic;"> (If available)</span></label></div>
              <div><input type="text" style="width: 100%;" placeholder="Company" id="wpcargo_receiver_company" name="wpcargo_receiver_company" value="<?php echo get_post_meta($post->ID, 'wpcargo_receiver_company', true); ?>" /></div>
            </div>
            <div class="wpcargo-col-md-6">
              <div><label class="form-label"> <?php esc_html_e('Main Phone Number', 'wpcargo'); ?> </label><span style="font-size: .87em;font-style: italic;"> (tick if number has WhatsApp)</span></div>
              ...
              <input class="wpcargo-col-md-5" style="width: 20px; height: 20px; margin: 3px 3px 3px 3px;" type='checkbox' name="whatsapp_1" id="whatsapp_1"><label style="font: bolder;"><img style="width: 30px;" src="<?php echo WPCARGO_PLUGIN_URL."assets/images/whatsapp.png"; ?>" title="Has whatsapp" alt="Whatsapp"></label>
            </div>
            <div class="wpcargo-col-md-6" style="margin-bottom: 1.5em;">
            ...
            <div class="wpcargo-col-md-6">
              ...
              <input class="wpcargo-col-md-5" style="width: 20px; height: 20px; margin: 3px 3px 3px 3px;" type='checkbox' name="whatsapp_2" id="whatsapp_2"><label style="font: bolder;"><img style="width: 30px;" src="<?php echo WPCARGO_PLUGIN_URL."assets/images/whatsapp.png"; ?>" title="Has whatsapp" alt="Whatsapp"></label>
            </div>
            <div class="wpcargo-col-md-6">
           ...
           <div class="wpcargo-col-md-6">
              ...
              <div><input type="email" style="width: 90%;" class="notvalidate" id="wpcargo_receiver_email" name="wpcargo_receiver_email" value="<?php echo get_post_meta($post->ID, 'wpcargo_receiver_email', true); ?>" /> </div>
           </div>
    </div>
...
<div class="tab" id="collection-instructions">
  <h2><?php echo apply_filters('wpc_receiver_details_label',esc_html__('Terms and Conditions', 'wpcargo' ) ); ?></h2><hr style="border: 1px solid black;"/>
  <div class="wpcargo-row">
   <div class="wpcargo-col-md-6">
